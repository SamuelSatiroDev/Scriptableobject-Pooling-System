...
{
    [CreateAssetMenu(fileName = "PoolingManagerStandard", menuName = "Rage Machine/Pooling/Pooling Manager Standard")]
    public sealed class PoolingManagerStandard : ScriptableSingleton<PoolingManagerStandard>
    {
